...
<body>
 ...
 <div id="navbar" class="navbar-collapse collapse">
    ...
    <label class="navbar-text text-center text-primary" style="vertical-align:10px;font-size:medium ">Hallo! <font style="font-size:13px"> <?php echo $_SESSION["user"]; ?></font> </label>
